...
namespace IdentityBase.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            IdentityResult result = await UserManager.AddLoginAsync(Int32.Parse(User.Identity.GetUserId()), loginInfo.Login);
            if (result.Succeeded)
            {
        ...
        //    var acces_token = claimsforUser.FirstOrDefault(x => x.Type == "FacebookAccessToken");
        //    var fb = new FacebookClient(access_token);

        //    dynamic myInfo = fb.Get("/me");

        //    dynamic myFeed = fb.Get("/me/feed");

        //    //dynamic myPicture = fb.Get(string.Format("/me"));

        //    var meInfo = new FacebookMeInfo()
        //    {
        //        Name = string.Format("{0}", myInfo["first_name"]),
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            AuthenticationManager.SignIn(new AuthenticationProperties() { IsPersistent = isPersistent }, await UserManager.GenerateUserIdentityAsync(UserManager, user));
        }
